...
violinplot.matrix <- function(x, col='grey50', names = 1:ncol(x), scale = 1, show.median = TRUE, 
                       show.box = FALSE, box.big = 5, box.small = 2, bars = FALSE, 
                       add = FALSE, xlab='', ylab='', width = 1, col.pt = 'black', ...){
...
violinplot.list <- function(x, col='grey50', names = 1:length(x), scale = 1, show.median = TRUE, 
                              show.box = FALSE, box.big = 5, box.small = 2, bars = FALSE, 
                              add = FALSE, xlab='', ylab='', width = 1, col.pt = 'black', ...){
